...
<title>Recode Viagens - Pesquisa</title>
...
<body>
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse flex-row-reverse"
					...
					<ul class="navbar-nav d-flex align-items-center">
						...
						<li class="nav-item"><a href="Destinos"
							class="nav-link active"> <i class="fas fa-map-marked-alt"></i>
								Destino
						</a></li>
						<li class="nav-item"><a href="Promocoes" class="nav-link">
	...
	<main class="container-fluid">
		<section class="container">
			...
			<jstl:if test="${empty pesquisaDestino}">
				<h2 class="text-primary text-center">Destino não encontrado</h2>
				<div class="d-flex justify-content-center">
					<a href="Destinos" class="btn btn-primary btn-lg text-center">
						Voltar </a>
				</div>

			</jstl:if>

			<jstl:if test="${not empty pesquisaDestino}">
				<h2 class="text-primary">Resultado da Pesquisa</h2>
				<div class="d-flex justify-content-center mt-3 flex-wrap w-100 g-4">
					<jstl:forEach items="${pesquisaDestino}" var="viagem">
						<div class="card">
							<div class="card-header bg-success">
								<h5 class="card-title text-white text-center">
									<i class="fas fa-plane"></i> ${viagem.destino} /
									${viagem.localidade}
								</h5>
							</div>
							<div class="card-body text-center">
								<img src="${viagem.imagem}"
									class="card-img rounded img-fluid img-thumbnail border-0"
									alt="">
								<p class="card-text mt-1">
									<abbr title="Data da Viagem"><i
										class="fas fa-plane-departure"></i></abbr> ${viagem.data_ida} /
								</p>
								<p class="card-text">
									<span class="text-secondary fs-3">10x</span> <span
										class="text-primary fs-2"><fmt:formatNumber
											value="${viagem.preco/10}" type="currency"
											currencySymbol="R$ " /> </span>
								</p>
								<a href="DetalhesDestino?id=${viagem.id}"
	...
	<%-- 	<main class="container-fluid">
		<section class="container">
			<form class="input-group" action="Pesquisar" method="post">
				<input type="search" class="form-control my-4"
					placeholder="Pesquisar Destinos" name="pesquisaDestino" aria-label="Pesquisar Destinos"
			...
			<div class="d-flex justify-content-center mt-3 flex-wrap w-100 g-4">
				...
				<jstl:forEach items="${pesquisaDestino}" var="viagem">
					<div class="card">
						...
						<div class="card-header bg-success">
							<h5 class="card-title text-white text-center">
								<i class="fas fa-plane"></i> ${viagem.destino} / ${viagem.localidade}
							</h5>
						</div>
						<div class="card-body text-center">
							<img src="${viagem.imagem}"
								class="card-img rounded img-fluid img-thumbnail border-0" alt="">
							<p class="card-text mt-1">
								<i class="fas fa-calendar-alt"></i> ${viagem.data_ida} <i
									class="fas fa-user"></i>
							</p>
							<p class="card-text">
								<span class="text-secondary fs-3">10x</span> <span
							...
							<a href="" class="btn btn-warning px-5 fw-semibold btnPromocao">Ver
								Pacote <i class="fas fa-arrow-right"></i>
							</a>
						</div>
					</div>
