...
<head>
    ...
    <title>Recode Viagens - Contato</title>
				...
				<div class="collapse navbar-collapse flex-row-reverse"
					...
					<ul class="navbar-nav d-flex align-items-center">
						<jstl:choose>
							...
							<jstl:otherwise>
								<li class="nav-item"><a href="../IndexLogado.jsp" class="nav-link">
								<i class="fas fa-home"></i> Página Principal
						</a></li>
							</jstl:otherwise>
						</jstl:choose>
						<li class="nav-item"><a href="/Agencia-Viagem-V2/Destinos" class="nav-link">
								<i class="fas fa-map-marked-alt"></i> Destino
						</a></li>
						<li class="nav-item"><a href="/Agencia-Viagem-V2/Promocoes"
							class="nav-link"> <i class="fas fa-tags"></i>
								Promoções
						</a></li>
        ...
        <div class="mask" style="background-color: rgba(0, 0, 0, 0.6);">
            <div class="d-flex justify-content-center align-items-center h-100 w-100">
                <div class="text-white">
                    ...
                    <h4 class="mb-3">Nos conte, como podemos te ajudar?</h4>
                </div>
            </div>
        </div>
    </div>
    ...
    <main class="container-fluid mb-6">
        <section class="container">
            <div class="input-group">
                <input type="search" class="form-control my-4" placeholder="Encontrar Respostas" aria-label="Encontrar Respostas" aria-describedby="search-addon" />
                <button type="button" class="btn btn-primary my-4">Pesquisar</button>
            </div>
        </section>
        ...
        <section class="container mb-4">
            ...
            <div class="row row-cols-auto justify-content-center">
                ...
                <div class="col mb-4">
                    <a href="#" class="btn btn-light rounded border-success p-5">
                        <span class="position-top text-primary text-center fs-5">Ajuda com Pacotes</span>
                    </a>
                </div>
                <div class="col mb-4">
                    <a href="#" class="btn btn-light rounded border-success p-5">
                        <span class="position-top text-primary text-center fs-5">Assistência Jurídica</span>
                    </a>
                </div>
        ...
        <h2 class="text-muted text-center mb-4">Não encontrou a resposta acima? Entre em contato conosco <i class="fas fa-level-down-alt"></i></h2>
        <section class="container rounded" id="formularioContato">
            <form class="form-group p-2">
                <div class="mb-3">
                    <label for="inputContatoEmail" class="form-label">Insira seu e-mail (*): </label>
                    <input type="email" class="form-control" id="inputContatoEmail" placeholder="nome@exemplo.com" required>
                </div>
                <div class="mb-3">
                    <label for="inputContatoNome" class="form-label">Insira seu nome (*): </label>
                    <input type="text" class="form-control" id="inputContatoNome" placeholder="Nome e Sobrenome" required>
                </div>
                <div class="mb-3">
                    <label for="inputContatoTel" class="form-label">Insira seu telefone (*): </label>
                    <div class="input-group">
                        <input type="text" class="form-control" aria-label="NÃºmero de Telefone" id="inputContatoTel" placeholder="(**)*****-****" required>
                        <div class="input-group-text">
                            <span class="text-muted px-2">WhatsApp? </span> 
                            <input class="form-check-input mt-0" type="checkbox" value="" aria-label="WhatsApp">
                        </div>
                    </div>   
                </div>
                <div class="mb-3">
                    <label for="inputContatoTexto" class="form-label">Nos conte como podemos ajudar (*): </label>
                    <textarea class="form-control" id="inputContatoTexto" rows="3" required></textarea>
                </div>
                
                <div class="mb-3 mt-5">
                    <h3 class="fs-5">Como você prefere nosso retorno? (*)</h3>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="retornoContato" id="emailRetorno">
                        <label class="form-check-label" for="emailRetorno">
                           Por E-mail
                        </label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="retornoContato" id="telRetorno">
                        <label class="form-check-label" for="telRetorno">
                          Por Telefone
                        </label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="retornoContato" id="whatsRetorno">
                        <label class="form-check-label" for="whatsRetorno">
                          Por WhatsApp
                        </label>
                      </div>
        ...
        <section class="container-fluid my-4">
            <div class="row">
                <div class="col mb-4">
                    ...
                    <p><span class="fw-semibold">Endereço: </span>Avenida das Viagens, 100 - São Paulo, SP. CEP: 08123-456</p>
                    <p><span class="fw-semibold">Tel.:</span> (11)4321-1234 / (11)91234-5678</p>
                    <p><span class="fw-semibold">E-mail: </span> RecodeViagens@viagens.com.br</p>
                </div>
                ...
                <div class="col mb-4">
                    ...
                    <p><a href="#" class="linksFooter fw-semibold">Entre em Contato</a></p>
                </div>
                ...
                <div class="col">
                    ...
                    <span class="bg-image">
                        <img src="../assets/image/payment-method.jpg" alt="Métodos de Pagamento" style="width: 300px; height: 100px;">
                    </span>
                </div>
            </div>
            <div class="container text-center my-3">
                <p>	&copy; 2023, Manoel - Todos os Direitos Reservados à Recode Viagens</p>
            </div>
        </section>
    </footer>
