							...
							<div class="card-body p-md-5">
								<div class="row justify-content-center">
									<div class="col-xxl-4">
										...
										<jstl:forEach items="${dadoReserva}" var="reserva">
										<p class="text-center h2 fw-bold mb-5 mt-4">Dados da sua
											...
											<ul class="list-group">
												...
												<li class="list-group-item">Data da Reserva:
													<span class="dataReserva">${reserva.data_reserva}</span></li>
												<jstl:forEach items="${dadoViagem}" var="viagem">	
 													<li class="list-group-item">Destino: ${viagem.destino}</li>
 													<li class="list-group-item">Data de Ida: <span class="dataConvert">${viagem.data_ida}</span></li>
 													<li class="list-group-item">Data de Ida: <span class="dataConvert">${viagem.data_volta}</span></li>
 													<li class="list-group-item">Tipo do Pacote: ${viagem.tipo_pacote}</li>
 												</jstl:forEach> 
												<li class="list-group-item">Preço: <fmt:formatNumber value="${reserva.preco}" type="currency" currencyCode="BRL" /></li>
												<li class="list-group-item">Número de Passageiros:
													${reserva.num_passageiros}</li>
											</ul>
										</jstl:forEach>
										
										<div class="py-3 d-flex justify-content-center">
											<a href="/Agencia-Viagem-V2/Reservas" class="btn btn-primary text-white"> Voltar para Reservas</a>
										</div>
