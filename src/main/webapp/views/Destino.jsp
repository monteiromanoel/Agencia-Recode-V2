					...
					<div class="card">
						...
						<div class="card-body text-center">
							...
							<p class="card-text mt-1">
								<abbr title="Data de Ida e Volta"><i
									class="fas fa-plane-departure"></i></abbr> <span class="dataConvert">${viagem.data_ida}</span>  ||  <i class="fas fa-plane-arrival"></i> <span class="dataConvert">${viagem.data_volta}</span>
							</p>
							<p class="card-text">
