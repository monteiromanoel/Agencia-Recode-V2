		...
		<header class="container">
			<nav class="navbar navbar-expand-lg fixed-top navbar-dark shadow-sm"
				...
				<div class="container-fluid">
					<a href="./Dashboard.jsp" class="navbar-brand"> Adm - Recode
						Viagens </a>
		...
		<div class="container conteudo">
			...
			<main class="col pt-2 pb-4">
				...
				<form class="mx-1 mx-md-4"
					action="<%=request.getContextPath()%>/CadastroCliente"
					id="formPerfil" method="post">

					<div class="d-flex flex-row align-items-center mb-4">
						<div class="form-outline flex-fill mb-0">
							<label class="form-label" for="nomeCliente">Nome</label> <input
								type="text" id="nomeCliente" class="form-control" name="nome"
								required />
						</div>
					</div>
					...
					<div class="d-flex flex-row align-items-center mb-4">
						<div class="form-outline flex-fill mb-0">
							<label class="form-label" for="emailCliente">E-mail</label> <input
								type="text" id="emailCliente" class="form-control" name="email"
								required />
						</div>
					</div>
					...
					<div class="d-flex flex-row align-items-center mb-4">
						<div class="form-outline flex-fill mb-0">
							...
							</label> <input type="text" id="logradouroCliente" class="form-control"
								name="logradouro" required />

							<div class="d-flex flex-row align-items-center my-2">
								<input type="text" id="cepCliente" class="form-control w-25"
									name="cep" required /> <input type="text" id="cidadeCliente"
									class="form-control w-50 mx-2" name="cidade" required /> <select
									id="estado" class="form-control form-select w-25" name="uf">
					...
					<div class="d-flex flex-row align-items-center mb-4">
						<div class="form-outline flex-fill mb-0">
							<label class="form-label" for="dataNasc">Data de
								Nascimento</label> <input type="date" id="dataNasc" class="form-control"
