...
<script src="./views/dashboard/js/deleteUsuario.js"></script>
						...
						<table class="table table-hover text-center">
							<thead>
								<tr>
									...
									<td scope="col" class="headerTable text-white">Endereço</td>
									<td scope="col" class="headerTable text-white">CEP</td>
									<td scope="col" class="headerTable text-white">Cidade / UF</td>
									<td scope="col" class="headerTable text-white">Telefone</td>
									<td scope="col" class="headerTable text-white">Documento</td>
									<td scope="col" class="headerTable text-white">Data de
										Nascimento</td>
								</tr>
							</thead>
							<jstl:forEach items="${clientes}" var="cliente">
								<tbody>
									<tr scope="row">
										...
										<td><span class="dataConvert">${cliente.data_nasc}</span></td>
										<td>
											<div class="d-flex justify-content-end">
												<!-- Modificar o caminho antes de ? para o servlet correto -->
												<a
													href="/Agencia-Viagem-V2/VisualizarDetalhesCliente?idCliente=${cliente.id}"
												...
												<!-- Modificar o caminho antes de ? para o servlet correto -->
												<a
													href="/Agencia-Viagem-V2/VerPerfilUsuario?idCliente=${cliente.id}"
													style="cursor: pointer;"
												...
												<!-- Modificar o caminho antes de ? para o servlet correto -->
												<a href="#" onclick="confirmarDeletar(${cliente.id})"
													style="cursor: pointer;"
