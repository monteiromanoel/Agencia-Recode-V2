...
<head>
<meta charset="UTF-8">
<title>ADM - Atualizar Reserva</title>
										...
										<div class="row justify-content-center">
											<div class="col-xxl-5">
												<jstl:forEach items="${reserva}" var="reserva">
													...
													<form class="mx-1 mx-md-4" action="AtualizarReserva"
														id="formPerfil" method="post">

														<input value="${reserva.id}" name="id" hidden />
														...
														<div
															...
															<div class="form-outline flex-fill mx-1 mb-2">
																<label class="form-label" for="idCliente">Informe
																	o ID do Cliente</label>
																<jstl:forEach items="${clienteR}" var="cliente">
																	<input type="text" id="idCliente" class="form-control text-center"
																		name="idCliente" value="${reserva.idCliente.id}"
																		required />
																	<span class="text-muted">Cliente original:
																		${cliente.nome}</span>
																</jstl:forEach>
															</div>
															<div class="form-outline flex-fill mb-2">
																<label class="form-label" for="idViagem">Informe
																	o ID do Pacote</label>
																<jstl:forEach items="${viagemR}" var="viagem">
																	<input type="text" id="idViagem" class="form-control text-center"
																		name="idViagem" value="${reserva.idViagem.id}"
																		required />
																	<span class="text-muted">Destino original:
																		${viagem.destino} - ${viagem.localidade}</span>
																</jstl:forEach>
														...
														<div
															class="d-flex flex-row flex-wrap align-items-center mb-4 mt-3">
															<div class="form-outline flex-fill mx-1 mb-2">
																<label class="form-label" for="adicional">Número
																	de Passageiros</label> <input type="number" id="adicional"
																	class="form-control w-25 text-center" name="num_passageiros"
																	value="${reserva.num_passageiros}" required />
															</div>
														</div>
														
														<h2 class="text-center my-3"> Valor final será calculado ao salvar a reserva</h2>
