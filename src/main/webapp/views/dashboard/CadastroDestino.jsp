...
<head>
<meta charset="UTF-8">
<title>ADM - Cadastrar Destino</title>
								...
								<div class="card text-black" style="border-radius: 25px;">
									<div class="card-body p-md-5">
										<div class="row justify-content-center">
											<div>
												<h1 class="text-center mb-3">Cadastrar Destino</h1>
												<form class="mx-1 mx-md-4 mt-2" action="<%=request.getContextPath()%>/CadastrarDestino"
													...
													<div
														...
														<div class="form-outline flex-fill mx-1 mb-0">
															<label class="form-label" for="destino">Destino</label> <input
																type="text" id="destino" class="form-control"
																name="destino" placeholder="Insira um destino" required />
														</div>
														<div class="form-outline flex-fill mb-0">
															<label class="form-label" for="localidade">País
																...
																placeholder="Insira o país ou localidade" required />
														</div>
													</div>
													...
													<div
														...
														<div class="form-outline flex-fill mx-1 mb-0">
															<label class="form-label" for="dataIda">Data de
																Ída</label> <input type="date" id="dataIda" class="form-control"
																name="data_ida" required />
														</div>
														<div class="form-outline flex-fill mx-1 mb-0">
															<label class="form-label" for="dataVolta">Data de
																Volta</label> <input type="date" id="dataVolta"
													...
													<div class="d-flex flex-row align-items-center mb-4">
														<div class="form-outline flex-fill mb-0">
															...
															<textarea id="textAreaCurta" name="descricao_curta"
																class="form-control" maxlength="300" placeholder="Insira uma descrição curta"></textarea>
														</div>
													</div>
													...
													<div class="d-flex flex-row align-items-center mb-4">
														<div class="form-outline flex-fill mb-0">
															...
															<textarea id="textArea" name="descricao_longa"
																maxlength="4500" placeholder="Insira uma descrição longa"></textarea>
														</div>
													</div>
																...
																<div class="row">
																	<div class="col-8">
																		<label class="form-label" for="labelPromocao">Etiqueta
																			...
																			placeholder="Texto da etiqueta" maxlength="40" />
																	</div>
																	<div class="col-4">
																		<label class="form-label" for="precoAntigo">Preço
																			...
																			value="<fmt:formatNumber value="0" type="currency"
												currencyCode="BRL" />" />
												...
												currencyCode="BRL" />"
													...
													<div
														...
														<div class="form-outline flex-fill mb-0 w-50 mx-1">
															<label class="form-label" for="imagem">Imagem de
																Capa</label> <input type="text" id="imagem" class="form-control"
																name="imagem" placeholder="Adicione o link da imagem" required /> 
																<label
																class="form-label" for="imagem2">Imagem 2</label> 
																<input
														...
														<div class="form-outline flex-fill mb-0 w-50 mx-1">
															...
															<input type="text" id="imagem3" class="form-control"
																name="imagem3"
																placeholder="Adicione o link da imagem" /> <label
																class="form-label" for="imagem4">Imagem 4</label> <input
													...
													<div
														...
														<button type="submit" class="btn btn-success btn-lg">Cadastrar Destino</button>
													</div>
												</form>
