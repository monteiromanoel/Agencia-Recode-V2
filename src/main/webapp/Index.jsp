			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse flex-row-reverse"
					...
					<ul class="navbar-nav d-flex align-items-center">
						<li class="nav-item"><a href="./views/dashboard/Dashboard.jsp"
							class="nav-link"> <i class="fas fa-user-cog"></i> Página
								Administrador
						</a></li>
						<li class="nav-item"><a href="Index.jsp"
							class="nav-link active"> <i class="fas fa-home"></i> Página
								Principal
						</a></li>
						...
						<li class="nav-item"><a href="/Agencia-Viagem-V2/views/Contato.jsp"
							class="nav-link"><i class="fas fa-phone"></i> Contato</a></li>
						...
						<c:choose>
							...
							<c:otherwise>
								<li class="nav-item"><a href="perfil.html" class="nav-link"><i
										class="fas fa-user"></i> Perfil</a></li>
								<li class="nav-item"><a href="reservas.html"
					...
					<div class="form-group mb-3">
						<div class="col-md-6 offset-md-3">
							<input type="text" name="pesquisaDestino" class="form-control"
								placeholder=" Insira o DESTINO" required="">
						</div>
						<br> <input type="submit"
							value="  Buscar Pacotes de Viagem  "
							class="btn btn-warning shadow" id="btnBuscaPct">
					</div>
				</div>
			</form>
		</section>
		...
		<div id="carouselExampleCaptions" class="container-sm carousel slide"
			...
			<div class="carousel-inner">
				<div class="carousel-item active" data-bs-interval="5000">
					<img src="./assets/image/netherlands-1-1.jpg" class="d-block w-100"
						alt="...">
